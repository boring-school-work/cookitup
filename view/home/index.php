...
<head>
    ...
    <link rel="icon" id="Favicon" type="image" href="../../assets/images/chef-hat.png">
...
<body>
    ...
    <div class="featured-tab" id="featuredSection">
        <img src="../../assets/images/Foods/Grilled_Cheese_008-1-c81076b16bc44caea8077666695be94d.jpg" class="featured-img" id="featured-img"/>
        <h1> 
            <span id="featured-text"> Featured Recipe </span> <br> 
            <span class="spanH2" id="featured-name">Grilled Cheese Sandwiches</span><br>
            <span><img class="rating" id="featured-rating" src="../../assets/images/4-star.png" alt="rating" /></span>
            ...
            <button type="button" id="userButton" class="user-button">
                ...
                <span class="button-icon"><img src="../../assets/images/Users/a3lh4g4p0w881.jpg" class="user-profile-pic" id="usericon"></span>
          </button>
        </h1>

        <img src="../../assets/images/left-chevron.png" class="chevron-left" id="left-arrow"/>
        <img src="../../assets/images/right-chevron.png" class="chevron-right" id="right-arrow"/>
    </div>
    ...
    <div class="search-container">
        <form action="/action_page.php" class="search-bar">
          ...
          <button type="submit"> <img src="../../assets/images/search23.png"> </button>
        </form>
      </div>
    
    <div class="explore-row">

        <div class="recipe-card" style="margin-left: 70px;"> <img src="../../assets/images/chorizo-mozarella-gnocchi-bake-cropped-9ab73a3.jpg" class="recipe-img"/> 
            <div class="card-data">
            Garlic Bell Pepper Pasta <br>
             <img src="../../assets/images/5-star.png" class="rating">
             <button type="button" id="miniUserButton1" class="mini-user-button">
                <span class="mini-button-icon"><img src="../../assets/images/Users/a3lh4g4p0w881.jpg" class="mini-user-profile-pic"></span>
                <span class="mini-button-text"> The Clean Goblin </span>
          </button>
            </div> 
        </div>

        <div class="recipe-card"> <img src="../../assets/images/chorizo-mozarella-gnocchi-bake-cropped-9ab73a3.jpg" class="recipe-img"/> 
            <div class="card-data">
             Garlic Bell Pepper Pasta <br>
             <img src="../../assets/images/5-star.png" class="rating">
